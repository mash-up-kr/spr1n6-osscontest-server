...
import com.osscontest.server.search.infrastructure.RetrySleeper
...
/**
 * OpenAI 질의 임베딩 호출 전용 RestClient. 검색은 실시간 요청 경로에 있어 인덱싱보다
 * 짧은 타임아웃을 쓴다.
 *
...
class EmbeddingClientConfig(
    ...
    @Bean
    fun embeddingRetrySleeper(): RetrySleeper = RetrySleeper(Thread::sleep)
}
